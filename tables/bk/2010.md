...
| International organization participation: | BIS, CE, CEI, EAPC, EBRD, FAO, G-77, IAEA, IBRD, ICAO, ICCt, ICRM, IDA, IDB, IFAD, IFC, IFRCS, ILO, IMF, IMO, IMSO, Interpol, IOC, IOM, IPU, ISO, ITSO, ITU, ITUC, MIGA, MONUSCO, NAM (observer), OAS (observer), OIC (observer), OPCW, OSCE, PFP, SECI, UN, UN Security Council (temporary), UNCTAD, UNESCO, UNIDO, UNWTO, UPU, WCO, WHO, WIPO, WMO, WTO (observer) |
...
| GDP (purchasing power parity): | $30.56 billion (2010 est.) |
