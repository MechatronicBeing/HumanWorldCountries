...
| Terrorism | West Bank |
| --- | --- |
| Terrorist groups - home based: | Kahane Chai (Kach): aim(s): restore the biblical state of Israel; expel Arabs from Israel's biblical lands |
...
| Terrorist groups - foreign based: | HAMAS: aim(s): grow its political and operational presence in the West Bank |
...
| | aim(s):Â  launch attacks against Israel, reduce Israelâ€™s presence and influence in the West Bank, and destroy the state of Israel; works through proxies and allies such as Hamas, Palestine Islamic Jihad (PIJ), Palestine Liberation Front (PLF), and Popular Front for the Liberation of Palestine (PFLP) |
| | area(s) of operations:Â  West Bank |
| | (2019) |
...
| Refugees and internally displaced persons: | refugees (country of origin): 846,465 (Palestinian refugees) (2019) |
