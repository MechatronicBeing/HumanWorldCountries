...
| Executive branch: | chief of state: KIM Jong Un [heir apparent} (since September 2011); note - the rubberstamp Supreme People's Assembly (SPA) reelected KIM Yong Nam in 2009 president of its Presidium also with responsibility of representing state and receiving diplomatic credentials |
...
| | 3.7% (2008 est.) |
| GDP - per capita (PPP): | $1,800 (2009 est.) |
