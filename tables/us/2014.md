...
| Urbanization: | urban population: 82.4% of total population (2011) |
...
| Refugees and internally displaced persons: | refugees (country of origin): the US admitted 69,926 refugees during FY2013 including: 19,488 (Iraq); 16,299 (Burma); 9,134 (Bhutan); 7,608 (Somalia); 4,205 (Cuba); 2,578 (Iran); 1,824 (Eritrea) |
