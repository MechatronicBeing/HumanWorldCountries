...
| --- | --- |
| Telephones - fixed lines: | total subscriptions: 113,852 |
| | subscriptions per 100 inhabitants: 35 (2017 est.) |
| | country comparison to the world: 140 |
| Telephones - mobile cellular: | total subscriptions: 353,540 |
| | subscriptions per 100 inhabitants: 107 (2017 est.) |
| | country comparison to the world: 176 |
| Telephone system: | general assessment: modern facilities; Â the telecom sector provides a relatively high contribution to overall GDP; activation ofÂ Mobile Number Portability (MNP) in April 2017, allowing mobile subscribers to port their numbers betweenÂ competing MNO (mobile network operators) (2018) |
| | domestic: totally automatic system; highly developed; operators focus investment on mobile networks;Â 30 per 100 fixed-line,Â 93 per 100 mobile-cellular (2018) |
...
| Broadband - fixed subscriptions: | total: 86,868 |
| | subscriptions per 100 inhabitants: 26 (2017 est.) |
| | country comparison to the world: 123 |

| Military and Security | Bahamas, The |
| --- | --- |
| Military and security forces: | Royal Bahamas Defense Force: Patrol Squadron, Commando Squadron, and Air Wing (2019) |
