...
| | head of government: Prime Minister THONGSING Thammavong (since 24 December 2010); Deputy Prime Ministers Maj. Gen. ASANG Laoli (since May 2002), Lt. Gen. DOUANGCHAI Phichit (since 8 June 2006), SOMSAVAT Lengsavat (since 26 February 1998), and THONGLOUN Sisoulit (since 27 March 2001) |
...
| International organization participation: | ADB, ARF, ASEAN, CP, EAS, FAO, G-77, IBRD, ICAO, ICRM, IDA, IFAD, IFC, IFRCS, ILO, IMF, Interpol, IOC, IPU, ISO (subscriber), ITU, MIGA, NAM, OIF, OPCW, PCA, UN, UNCTAD, UNESCO, UNIDO, UNWTO, UPU, WCO, WFTU, WHO, WIPO, WMO, WTO (observer) |
...
| GDP (purchasing power parity): | $15.42 billion (2010 est.) |
