...
| Flag description: | two narrow red horizontal bands encase a wide white band; centered on the white band is a disk with a blue and white wave pattern on the lower half and a gold and white ray pattern on the upper half; a stylized red, blue, and white ship rides on the wave pattern |
