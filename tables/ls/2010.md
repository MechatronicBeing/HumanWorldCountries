...
| International organization participation: | CE, EBRD, EFTA, IAEA, ICCt, ICRM, IFRCS, Interpol, IOC, IPU, ITSO, ITU, ITUC, OPCW, OSCE, PCA, Schengen Convention (de facto member), UN, UNCTAD, UPU, WIPO, WTO |
...
| GDP (official exchange rate): | $4.603 billion (2007) |
| GDP - real growth rate: | 3.1% (2007 est.) |
| | country comparison to the world: 116 |
| GDP - per capita (PPP): | $122,100 (2007 est.) |
| | country comparison to the world: 2 |
| GDP - composition by sector: | agriculture: 8% |
| | industry: 39% |
| | services: 54% (2007) |
| Labor force: | 32,440 of whom 16,200 commute from Austria, Switzerland, and Germany to work each day (2008) |
